...
def rawaccl_to_binryseq(inp_vibr_df,downsample_rate,use_filt_accl_flag):
    """
    ...
    + 0.10 * ((acc_sig >= 0.05) & (acc_sig < 0.10)) \
    + 0.20 * ((acc_sig >= 0.10) & (acc_sig < 0.15)) \
    + 0.30 * ((acc_sig >= 0.15) & (acc_sig < 0.20)) \
    + 0.40 * ((acc_sig >= 0.20) & (acc_sig < 0.25)) \
    + 0.50 * ((acc_sig >= 0.25) & (acc_sig < 0.30)) \
    + 0.60 * ((acc_sig >= 0.30) & (acc_sig < 0.35)) \
    + 0.70 * ((acc_sig >= 0.35) & (acc_sig < 0.40)) \
    + 0.80 * ((acc_sig >= 0.40) & (acc_sig < 0.45)) \
    + 0.90 * ((acc_sig >= 0.45) & (acc_sig < 0.50)) \
    + 1.00 * ((acc_sig >= 0.50) & (acc_sig < 0.55)) \
    + 1.10 * ((acc_sig >= 0.55) & (acc_sig < 0.60)) \
    + 1.20 * ((acc_sig >= 0.60) & (acc_sig < 0.65)) \
    + 1.30 * ((acc_sig >= 0.65) & (acc_sig < 0.70)) \
    + 1.40 * ((acc_sig >= 0.70) & (acc_sig < 0.75)) \
    + 1.50 * ((acc_sig >= 0.75) & (acc_sig < 0.80)) \
    + 1.60 * ((acc_sig >= 0.80) & (acc_sig < 0.85)) \
    + 1.70 * ((acc_sig >= 0.85) & (acc_sig < 0.90)) \
    + 1.80 * ((acc_sig >= 0.90) & (acc_sig < 0.95)) \
    + 1.90 * ((acc_sig >= 0.95) & (acc_sig < 1.00)) \
    + 2.00 * ((acc_sig >= 1.00) & (acc_sig < 1.05)) \
    + 2.10 * ((acc_sig >= 1.05) & (acc_sig < 1.10)) \
    + 2.20 * ((acc_sig >= 1.10) & (acc_sig < 1.15)) \
    + 2.30 * ((acc_sig >= 1.15) & (acc_sig < 1.20)) \
    + 2.40 * ((acc_sig >= 1.20) & (acc_sig < 1.25)) \
    + 2.50 * ((acc_sig >= 1.25) & (acc_sig < 1.30)) \
    + 2.60 * ((acc_sig >= 1.30) & (acc_sig < 1.35)) \
    + 2.70 * ((acc_sig >= 1.35) & (acc_sig < 1.40)) \
    + 2.80 * ((acc_sig >= 1.40) & (acc_sig < 1.45)) \
    + 2.90 * ((acc_sig >= 1.45) & (acc_sig < 1.50)) \
    + 3.00 * (acc_sig >= 1.50)\
    ;
    ...
    #     h1_df,h1_mode = gen_histogram(quant_sig,0,0.10)
    # else:
    #     h1_df,h1_mode = gen_histogram(acc_sig,0,0.10)
    #end-if
    ...
    #end-if
    complex_board_thresh = 0.8
    simple_board_thresh = 0.6

    if mode > complex_board_thresh:
        HYS_LOW_THRESH = 2.4
        HYS_HIGH_THRESH = 2.8 
    elif mode < simple_board_thresh:
        HYS_LOW_THRESH = 1.0
        HYS_HIGH_THRESH = 1.5
